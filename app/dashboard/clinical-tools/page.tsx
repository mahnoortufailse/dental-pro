  ...
  const handleAddMedicalEntry = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setMedicalEntry({ notes: "", findings: "", treatment: "", medications: "" })
        setMedicalErrors({})
  ...
  const handleUploadImage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setImageUpload({ type: "xray", title: "", description: "", imageUrl: "", notes: "" })
        setImageErrors({})
                          ...
                          <form onSubmit={handleAddMedicalEntry} className="space-y-4 p-4 bg-muted rounded-lg">
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                onChange={(e) => {
                                  setMedicalEntry({ ...medicalEntry, notes: e.target.value })
                                  setMedicalErrors({ ...medicalErrors, notes: "" })
                                }}
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                onChange={(e) => {
                                  setMedicalEntry({ ...medicalEntry, findings: e.target.value })
                                  setMedicalErrors({ ...medicalErrors, findings: "" })
                                }}
                                className={`w-full px-4 py-2 bg-input border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-foreground placeholder-muted-foreground text-sm ${
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                onChange={(e) => {
                                  setMedicalEntry({ ...medicalEntry, treatment: e.target.value })
                                  setMedicalErrors({ ...medicalErrors, treatment: "" })
                                }}
                                className={`w-full px-4 py-2 bg-input border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-foreground placeholder-muted-foreground text-sm ${
                            ...
                            <input
                              ...
                              onChange={(e) => setMedicalEntry({ ...medicalEntry, medications: e.target.value })}
                              className="w-full px-4 py-2 bg-input border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-foreground placeholder-muted-foreground text-sm"
                            />
                            <button
                              type="submit"
                      ...
                      <div className="space-y-6">
                        ...
                        <form onSubmit={handleUploadImage} className="space-y-4 p-4 bg-muted rounded-lg">
                          ...
                          <select
                            ...
                            onChange={(e) => setImageUpload({ ...imageUpload, type: e.target.value })}
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                setImageUpload({ ...imageUpload, title: e.target.value })
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              onChange={(e) => {
                                setImageUpload({ ...imageUpload, imageUrl: e.target.value })
                                setImageErrors({ ...imageErrors, imageUrl: "" })
                              }}
                              className={`w-full px-4 py-2 bg-input border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-foreground placeholder-muted-foreground text-sm ${
                          ...
                          <textarea
                            ...
                            onChange={(e) => setImageUpload({ ...imageUpload, notes: e.target.value })}
                            className="w-full px-4 py-2 bg-input border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-foreground placeholder-muted-foreground text-sm"
                            rows={2}
                          />
                          <button
