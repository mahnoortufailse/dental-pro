...
export default function MedicalRecordsPage() {
  ...
  const fetchAllRecords = async (token: string, patientId: string) => {
    try {
      ...
      if (historyRes.ok) {
        ...
        console.log(
          "First entry doctor data:",
          data.history?.entries?.[0]?.doctorId
        ); // Debug log
  ...
  const handleDownloadHistoryEntry = async (
    ...
    try {
      ...
      doc.text("DENTAL CARE PRO", pageWidth / 2, yPosition, {
        align: "center",
      });
      yPosition += 8;
      ...
      doc.text("MEDICAL HISTORY RECORD", pageWidth / 2, yPosition, {
        align: "center",
      });
      yPosition += 10;
      ...
      doc.setTextColor(100, 100, 100);
      doc.text(
        `Record Date: ${new Date(entry.date).toLocaleDateString()}`,
        20,
        yPosition
      );
      yPosition += 10;
      ...
      yPosition += 6;
      doc.text(
        `Specialty: ${entry.doctorId?.specialty || "N/A"}`,
        25,
        yPosition
      );
      yPosition += 10;
        ...
        <main className="flex-1 lg:ml-0">
          <div className="">
            ...
            <div className="dashboard-header mb-8">
              <div>
                <h1 className="dashboard-title sm:text-3xl text-2xl">
                  Medical Records
                </h1>
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-start justify-between mb-4">
                              ...
                              <Button
                                onClick={() =>
                                  handleDownloadHistoryEntry(entry, idx)
                                }
