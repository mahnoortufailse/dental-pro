...
export async function POST(request: NextRequest) {
	try {
		...
		console.log(
			"[DEBUG] Doctor found:",
			doctor ? doctor.name : "No doctor found"
		);
		...
		if (patient && patient.phone) {
			...
			if (!whatsappResult.success) {
				console.warn(
					"  WhatsApp notification failed for appointment creation:",
					whatsappResult.error
				);
			} else {
				console.log(
					"  WhatsApp appointment confirmation sent:",
		...
		if (patient && patient.email) {
			...
			if (!emailResult.success) {
				console.warn(
					"  Email notification failed for appointment creation:",
					emailResult.error
				);
			} else {
				console.log(
					"  Email appointment confirmation sent:",
